...
class ColorCircleView constructor(
    context: Context,
    ...
    init {
        ...
        fillColorRes = a.getResourceId(R.styleable.ColorCircleView_fillColor, R.color.color_white)
        ...
        strokeColorRes = a.getResourceId(R.styleable.ColorCircleView_strokeColor, R.color.design_default_color_on_secondary)
        a.recycle()
    }
